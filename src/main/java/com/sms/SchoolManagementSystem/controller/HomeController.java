...
//        return "/index";
        Authentication authentication = SchoolManagementSystemApplication.authenticatedUser; //SecurityContextHolder.getContext().getAuthentication();
...
//        return "/index";
        SchoolManagementSystemApplication.authenticatedUser = null;
        return "/login";
